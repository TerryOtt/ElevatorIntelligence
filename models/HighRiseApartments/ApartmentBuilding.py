...
if __name__ == '__main__':
    ...
    jsonFilename = datetime.datetime.utcnow().strftime("activities_%Y%m%d_%H%M%S.json")
    building.generateActivityJsonFile( 
        datetime.date(2016, 12, 15), datetime.date(2016, 12, 15), jsonFilename )
